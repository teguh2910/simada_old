                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit RFQ APR</h3>
                        </div>
                        <!-- /.card-header -->
                        <form action="{{ route('rfq-apr.update', $rfqApr->id) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="spec_rm" name="spec_rm" value="{{ old('spec_rm', $rfqApr->spec_rm) }}"
                                                required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                @foreach ($periodes as $key => $value)
                                                    <option value="{{ $key }}"
                                                        {{ old('periode', $rfqApr->periode) == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('due_date', $rfqApr->due_date ? $rfqApr->due_date->format('Y-m-d') : '') }}"
                                                required>
                                            ...
                                            <select multiple
                                                ...
                                                @foreach ($suppliers as $supplier)
                                                    <option value="{{ $supplier }}"
                                                        {{ in_array($supplier, old('id_supplier', $rfqApr->suppliers)) ? 'selected' : '' }}>
                                                        {{ $supplier }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                @foreach ($pics as $pic)
                                                    <option value="{{ $pic->id }}"
                                                        {{ old('pic', $rfqApr->pic_id) == $pic->id ? 'selected' : '' }}>
                                                        {{ $pic->full_info }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @if ($errors->has('note')) is-invalid @endif" id="note" name="note"
                                                rows="3">{{ old('note', $rfqApr->note) }}</textarea>
                                            @if ($errors->has('note'))
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update RFQ APR
                                </button>
