                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit RFQ GP</h3>
                        </div>
                        <!-- /.card-header -->
                        <form action="{{ route('rfq-gp.update', $rfqGp->id) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="card-body">
                                @if ($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @if ($errors->has('spec')) is-invalid @endif" id="spec" name="spec"
                                                rows="3" placeholder="Enter specification details...">{{ old('spec', $rfqGp->spec) }}</textarea>
                                            @if ($errors->has('spec'))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                id="ex_rate" name="ex_rate" value="{{ old('ex_rate', $rfqGp->ex_rate) }}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                value="{{ old('qty_month', $rfqGp->qty_month) }}" min="0"
                                                placeholder="Enter quantity per month">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="satuan" name="satuan" value="{{ old('satuan', $rfqGp->satuan) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select multiple
                                                ...
                                                @if (count($suppliers) > 0)
                                                    @php
                                                        $selectedSuppliers = old(
                                                            'id_supplier',
                                                            $rfqGp->id_supplier
                                                                ? json_decode($rfqGp->id_supplier, true)
                                                                : [],
                                                        );
                                                        if (!is_array($selectedSuppliers)) {
                                                            $selectedSuppliers = $rfqGp->id_supplier
                                                                ? [$rfqGp->id_supplier]
                                                                : [];
                                                        }
                                                    @endphp
                            ...
                            <div class="card-footer">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update RFQ GP
                                </button>
