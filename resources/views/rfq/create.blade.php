                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Create New RFQ</h3>
                        </div>
                        <!-- /.card-header -->
                                            ...
                                            <select
                                                ...
                                                @foreach ($customers as $customer)
                                                    <option value="{{ $customer }}"
                                                        {{ old('customer') == $customer ? 'selected' : '' }}>
                                                        {{ $customer }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                id="std_qty" name="std_qty" value="{{ old('std_qty') }}" min="1"
                                                required>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                id="drawing_time" name="drawing_time" value="{{ old('drawing_time') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                id="OTS_Target" name="OTS_Target" value="{{ old('OTS_Target') }}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                id="OTOP_target" name="OTOP_target" value="{{ old('OTOP_target') }}">
